...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					商品展示 <small>全部商品</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/index.jsp"><i
							class="fa fa-dashboard"></i> 首页</a></li>
					<li><a
							href="${pageContext.request.contextPath}/pages/goods-list.jsp">商品展示</a></li>
									...
									<c:forEach items="${pageInfo.list}" var="goods" varStatus="i">
										<tr>
											...
											<td class="text-center">
												...
												<button onclick="add(${goods.goods_id})" class="btn bg-olive btn-xs">添加至购物车</button>
											</td>
										</tr>
									</c:forEach>
									</tbody>
	...
	<script type="text/javascript">
        ...
        function gotoPage(pageNum) {
            ...
            location.href="${pageContext.request.contextPath}/goods/main?pageNum="+pageNum+"&pageSize="+pageSize;
        }
        
        function add(goods_id) {
			$.ajax({
				url:"${pageContext.request.contextPath}/cart/save?goods_id="+goods_id,
				type:"get",
				success:function () {
