									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a onclick="deleteOne(${user.id})" class="btn bg-olive btn-xs">删除用户</a>
												<a href="${pageContext.request.contextPath}/user/saveRoleUI?id=${user.id}" class="btn bg-olive btn-xs">修改角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
